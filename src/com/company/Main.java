    ...
    public static void yellowDoor(Scanner scanner) {
        ...
        while (yellowKey == 0) {
            ...
            // Scenario 1
                ...
                System.out.println("Man: DO YOU EVEN CHOOSE YOUR WORDS?");
                                    ...
                                    if(programs.equals("open levelzero")){
                                        ...
                                        while (deepestWhile == 0) {
                                            ...
                                            || last.equals("playerIsTrapped=false;") || last.equals("playerIsTrapped = false;")){
                                                System.out.println(".\n====================================================================");
                                                System.out.println("Congrats! you figured your way out of LevelZero! Now back to the Real game" +
                                                        ", do you have a clue? it's three dimensional!\n==================================" +
                                                        "==================================\n.");
                                                exitLevelZero++;
                                                return;
                                            }
